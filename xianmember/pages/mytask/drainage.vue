		...
		<uni-page-head uni-page-head-type="default">
				<div class="uni-page-head" style="background:linear-gradient(90deg,#762f93,#e23b93,#f08300); color: rgb(255, 255, 255);">
					...
					<div class="uni-page-head-bd">
						<div class="uni-page-head__title" style="font-size: 16px; opacity: 1;">应用下载</div>
					</div>
					<!---->
				</div>
...
<!-- 				<view class="uni-per">
			...
			<view class="per">
				<view class="per-leber">下载地址<span style="color: red;">*</span></view>
				<view class="uni-per">
					<input style="font-size: 30rpx;" placeholder="请输入下载地址" v-model="url" class="input" />
				</view>
			</view>
			<view class="per">
			...
			<view class="per">
				<view class="per-leber">邀请码</view>
				<view class="uni-per">
					<input style="font-size: 30rpx;" placeholder="请输入推荐邀请码" v-model="mercId" class="input" />
				</view>
			</view>
<!-- 			<view class="textarea-group">
   ...
   <view style="margin-left:20rpx; color:darkgray;">注:下载地址格式只能是apk</view>
		</view>
		<!-- 地址 -->
		<!-- 	<view class="address">
