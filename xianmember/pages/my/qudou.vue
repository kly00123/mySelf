		...
		<uni-page-head uni-page-head-type="default">
			<div class="uni-page-head" style="background:linear-gradient(90deg,#762f93,#e23b93,#f08300); color: rgb(255, 255, 255);">
				...
				<div class="uni-page-head-bd">
					<div class="uni-page-head__title" style="font-size: 16px; opacity: 1;">渠豆明细 </div>
				</div>
				<!---->
		...
		<block v-for="(item,index) in myTasklist">
			<view class="starorder" style="height: 50px;">
				...
				<view class="uni-numbers" style="padding-left: 10px;">
					<view v-if="100==item.type||202==item.type||205==item.type"><span style="color:red">+{{item.money}}</span></view>
					<view v-if="102==item.type||103==item.type||104==item.type||201==item.type||206==item.type">-{{item.money}}</view>
