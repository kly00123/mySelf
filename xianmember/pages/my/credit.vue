		...
		<uni-page-head uni-page-head-type="default">
			<div class="uni-page-head" style="background:linear-gradient(90deg,#762f93,#e23b93,#f08300); color: rgb(255, 255, 255);">
				...
				<div class="uni-page-head-bd">
					<div class="uni-page-head__title" style="font-size: 16px; opacity: 1;">信用分</div>
				</div>
				<!---->
			</div>
		</uni-page-head>
		<view class="one_record">
			...
			<block v-for="(item,index) in rewardList">
				<view class="uni-records">
					<view style="font-size: 30rpx; color: #333333;margin-left: 24rpx;" v-if="item.type==0">信用增加</view>
					<view style="font-size: 30rpx; color: #FF5959;margin-left: 24rpx;" v-if="item.type==1">信用扣除</view>
					<view class="date">
						<view style="font-size: 36rpx; color: #333333;" v-if="item.type==0">+{{item.credit}}</view>
						<view style="font-size: 36rpx;color:#FF5959;" v-if="item.type==1">-{{item.credit}}</view>
						<view style="font-size:24rpx; color:#999999;">{{item.createTime}}</view>
						<view style="font-size:24rpx; color:#999999;">{{item.reason}}</view>
					</view>
				</view>
			</block>
		</view>
