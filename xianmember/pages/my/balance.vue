<template>
	<view class="page">
		...
		<uni-page-head uni-page-head-type="default">
				<div class="uni-page-head" style="background:linear-gradient(90deg,#762f93,#e23b93,#ef5e75); color: rgb(255, 255, 255);">
					...
					<div class="uni-page-head-bd">
						<div class="uni-page-head__title" style="font-size: 16px; opacity: 1;">余额</div>
					</div>
					<!---->
				</div>
		...
		<view class="uni-money">
			<view class="uni-money-a">余额(元)</view>
...
<!-- 		<view class="record" style="margin-top: 32rpx;" @click="capital()">
		...
		<!-- 提现额度 -->
<!-- 		<view class="record" style="margin-top: 32rpx;" >
			<view>提现额度</view>
			<view>{{moneyQuota}}元<image src="../../static/icons.png" class="icons"></image></view>			
		</view> -->
	</view>
...
<style>
	...
	.uni-money {
		...
		background:linear-gradient(90deg,#762f93,#e23b93,#ef5e75);
		opacity: 1;
	}
