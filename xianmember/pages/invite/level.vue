		...
		<uni-page-head uni-page-head-type="default">
				<div class="uni-page-head" style="background:linear-gradient(90deg,#762f93,#e23b93,#f08300); color: rgb(255, 255, 255);">
					...
					<div class="uni-page-head-bd">
						<div class="uni-page-head__title" style="font-size: 16px; opacity: 1;">合作</div>
					</div>
					<!---->
				</div>
					...
					<li class="table-view-li">
						<a>
							<div class="media-body">
								<a style="font-size: 30rpx;font-weight: bold;color:#5d5d5d">当前奖金排名</a>
					...
					<li class="table-view-li" v-for="(item,index) in taskList">
						<a>
							<div class="media-body">
								...
								<a style="color: #AFAFAF;font-size: 22rpx;">已获得<text class="textRed">￥{{item.money}}<text style="font-size: 22rpx;">元</text></text></a>
							</div>
						</a>
					</li>
				</ul>
