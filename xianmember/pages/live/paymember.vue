<template>
	<view class="page">
		...
		<uni-page-head uni-page-head-type="default">
			<div class="uni-page-head" style="background:linear-gradient(90deg,#762f93,#e23b93,#f08300); color: rgb(255, 255, 255);">
				...
				<div class="uni-page-head-bd">
					<div class="uni-page-head__title" style="font-size: 16px; opacity: 1;">支付</div>
				</div>
				<!---->
			</div>
		</uni-page-head>
		<view class="price">
			...
			<view class="uni-price-a">{{money}}<text style="font-size: 28rpx;">元</text></view>
...
<script>
	...
	export default {
		...
		onLoad: function(options) {
			...
			//is.info.price = JSON.parse(options);
